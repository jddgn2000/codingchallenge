...
<html>
  ...
  <div class="container">
    ...
    <h3>Methods</h3>
    <br />
    <button class="btn btn-success" onclick="add_api()"><i class="glyphicon glyphicon-plus"></i>Add new method</button>
    <br />
    <br />
				...
				<?php foreach($methods as $method){?>
				     <tr>
				         ...
				         <td><?php echo $method->desc;?></td>
                                         ...
                                         <td><?php echo $method->dsID;?></td>
						<td>
							<button class="btn btn-warning" onclick="edit_api(<?php echo $method->methodID;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
							<button class="btn btn-danger" disabled value="true" onclick="delete_api(<?php echo $method->methodID;?>)"><i class="glyphicon glyphicon-remove"></i></button>
                                                        <button class="btn btn-warning" ><a href="<?php echo site_url('index.php/api/metodo/')?><?php echo $method->methodID;?>/<?php echo $method->dsID;?>"><i class="glyphicon glyphicon-list-alt"></i></button>
                                                </td>
				      </tr>
				     <?php }?>
